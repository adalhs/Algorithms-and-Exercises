...
public class DistanceCalculator {
	...
	// Static method, because I am not creating (instantiating) a calculator object
	// in the main method
	public static void calculator(TreeMap<Integer, String> map) {
		...
		for (Map.Entry<Integer, String> result : map.entrySet()) {
			...
			if (cityNumber == 1) {
				...
				// If this is not the first city, prints "...miles from <previous city> (held in
				// startingPoint variable).
			} else {
				System.out.println("City #" + cityNumber + ": " + result.getValue() + ". Distance: "
