...
public class Application {
	...
	public static void main(String[] args) {
		...
		// Iterating through every letter in the string and saving city names/distances
		// in map
		// I am putting the distances as the keys and the names as the vaues because
		// TreeMaps sort through the key values
		// and this will make the subtraction of the next city's distance from the
		// previous city's distance easier
